...
function patchKeyedChildren(c1, c2, container) {
    ...
    while (i <= e1 && i <= e2) {
        ...
        if (!isSameVNodeType(prevChild, nextChild)) {
            ...
            console.log("prevChild:".concat(prevChild));
            console.log("nextChild:".concat(nextChild));
            break;
        }
    ...
    if (i > e1 && i <= e2) {
        while (i <= e2) {
            console.log("\u9700\u8981\u65B0\u521B\u5EFA\u4E00\u4E2A vnode: ".concat(c2[i].key));
        ...
        while (i <= e1) {
            console.log("\u9700\u8981\u5220\u9664\u5F53\u524D\u7684 vnode: ".concat(c1[i].key));
            hostRemove(c1[i].el);
            i++;
        }
    }
